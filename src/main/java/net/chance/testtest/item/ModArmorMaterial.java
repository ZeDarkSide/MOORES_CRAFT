...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    URANIUM("uranium", 17, new int[]{2, 5, 6, 2}, 9,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.URANIUM_INGOT});
    }),
    RUBY("ruby_arm", 25, new int[]{4, 5, 9, 4}, 12,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.5F, 0.5F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.RUBY_INGOT});
    }),
    PLUTONIUM("plutonium", 25, new int[]{3, 5, 7, 3}, 14,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, .5F, 0.1F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.PLUTONIUM_INGOT});
    }),
    DEATH("deathchestplate", 25, new int[]{10, 10, 10, 10}, 14,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, .5F, 0.1F, () -> {
